      ...
      <div className="container relative">
        <div className="max-w-3xl mx-auto text-center md:text-left md:mx-0">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl leading-relaxed">
            {c?.subtitle ?? "Explora nuestra colección curada de productos premium en electrónica, moda, hogar y deportes. Calidad excepcional, diseño único."}
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            <Button size="lg" className="group text-base px-8 py-6 rounded-xl shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300" asChild>
              <Link to="/products">
                {c?.cta_primary ?? "Explorar productos"}
                <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-1" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" className="text-base px-8 py-6 rounded-xl border-2 hover:bg-accent transition-all duration-300" asChild>
          ...
          <div className="flex items-center gap-6 mt-12 justify-center md:justify-start">
            ...
            <div className="text-sm">
              ...
              <span className="text-muted-foreground">{c?.trust_text ?? "+2,500 clientes satisfechos"}</span>
            </div>
          </div>
        </div>
      </div>
