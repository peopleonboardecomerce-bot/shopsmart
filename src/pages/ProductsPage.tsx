...
const ProductsPage = () => {
  ...
  const paginationItems = useMemo(() => generatePaginationItems(), [currentPage, totalPages]);
    ...
    <Layout>
      <div className="container py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="font-serif text-2xl sm:text-3xl font-bold mb-2 leading-tight">
            {searchQuery
          ...
          <div className="flex-1 min-w-0">
            {loading ? (
              ...
              <>
                ...
                {/* Pagination (mobile-friendly: wrap + scroll) */}
                {totalPages > 1 && (
                  <div className="mt-8">
